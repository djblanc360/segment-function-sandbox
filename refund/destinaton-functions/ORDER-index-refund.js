async function onRequest(request, settings) {
	...
	// const { order_status_url, financial_status, refunds, ...rest } = request.order

	// const headers = request.headers
	// console.log('headers', headers)
	// const order_status_url = headers.get('X-Shopify-Shop-Domain')
	// For Deployement
	const { order_status_url, financial_status, refunds, ...rest } =
		request.json();

	// For Source Code Compiler
	// const eventBody = request.json();
	// const { order_status_url, financial_status, refunds, ...rest } = eventBody.order;
